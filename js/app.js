(() => {
    ...
    function initSliders() {
        if (document.querySelector(".brends-slider__slider")) new core(".brends-slider__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
            ...
            loop: true,
            navigation: {
                prevEl: ".swiper-button-prev.brends-slider__arrow",
                nextEl: ".swiper-button-next.brends-slider__arrow"
            },
            breakpoints: {
                320: {
                    slidesPerView: 2,
